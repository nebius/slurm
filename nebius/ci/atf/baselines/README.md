...
Run the baseline workflow on `patch/NB-0001-sync-docs-and-tests`, then add the
reported tag to `baselines/<release>.txt` in the same pull request. Do not
change this pointer merely to rerun CI. A new pointer requires a deliberate
