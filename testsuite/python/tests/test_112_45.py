...
def test_specification(openapi_spec):
    ...
    # frozen upstream v0.0.45 schema. Compare the upstream surface separately;
    ...
    actual_spec["paths"].pop("/slurm/v0.0.45/nodes/reboot")
    actual_spec["paths"].pop("/slurm/v0.0.45/node/{node_name}/reboot")
    actual_spec["components"]["schemas"].pop(
        "v0.0.45_openapi_reboot_nodes_req"
    )
